...
class Qualities(Model):
    ...
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('qualities_book'))
...
class Gear(Model):
    ...
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('gear_book'))
...
class Weapon(Model):  
    ...
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('weapon_book'))
...
class Armor(Model):  
    ...
    legal = BooleanField(_('legal'), default=True)
    rarity = PositiveSmallIntegerField(_('rarity'), blank=False)
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('armor_book'))
...
class Attachment(Model):  
    ...
    rarity = PositiveSmallIntegerField(_('rarity'), blank=False)
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('attachment_book'))
...
class Vehicule(Model):  
    ...
    rarity = PositiveSmallIntegerField(_('rarity'), blank=False)
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('vehicule_book'))
...
class Starship(Model):  
    ...
    weapon = CharField(_('weapon'), blank=False, max_length=80)
    rarity = PositiveSmallIntegerField(_('rarity'), blank=False)
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('straship_book'))
...
class VehiculeAttachment(Model):  
    ...
    hardpoint = PositiveSmallIntegerField(_('hard point required'), blank=False)
    rarity = PositiveSmallIntegerField(_('rarity'), blank=False)
    index = ForeignKey(Book, on_delete=PROTECT, related_name=_('vehiculeattachment_book'))
